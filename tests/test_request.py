...
def test_search_to_str_dict():
    ...
    dump['adult_hand_bag'] = '1,1'
    dump['adult_hold_bag'] = '1,0'
    dump['adults'] = 2
    dump['atime_from'] = None
    dump['child_hand_bag'] = '1,1'
    dump['child_hold_bag'] = '2,1'
    dump['children'] = 2
    dump['conn_on_diff_airport'] = True
    dump['date_from'] = '1/10/2023'
    dump['date_to'] = '3/10/2023'
    dump['partner_market'] = 'us'
